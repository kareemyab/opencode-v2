...
export function NewSessionView(props: NewSessionViewProps) {
  ...
  return (
    <div class={ROOT_CLASS}>
      ...
      <div class="flex-1 min-h-0 px-6 pb-30 flex items-center justify-center text-center">
        <div class="mx-auto flex flex-col items-center text-center gap-4">
          ...
          <div class="flex flex-col items-center gap-4">
            ...
            <Show when={sync.project}>
              {(project) => (
                <div class="text-12-medium text-text-weak leading-5 text-center">
