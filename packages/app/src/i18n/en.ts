export const dict = {
  ...
  "settings.mcp.servers.empty": "No MCP servers configured. Use the editor below to add one.",
  ...
  "settings.mcp.editor.help": "Paste the contents of the global \"mcp\" object only. Project-local .opencode config is not shown here.",
