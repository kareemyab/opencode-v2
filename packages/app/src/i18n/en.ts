export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by orgn",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in orgn.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "orgn oLLM gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "orgn.com/docs",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in orgn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in orgn.",
  ...
  "prompt.placeholder.shell": "Enter shell command... {{example}} (Esc to cancel)",
  "prompt.placeholder.normal": "Ask anything... (/ for commands, @ for files)",
  "prompt.placeholder.simple": "Ask anything... (/ for commands, @ for files)",
  "prompt.placeholder.hints": "Ask anything... (/ for commands, @ for files)",
  ...
  "prompt.action.stop": "Stop generating response",

  "prompt.toast.pasteUnsupported.title": "Unsupported attachment",
  "prompt.toast.pasteUnsupported.description": "Only images, PDFs, or text files can be attached here.",
  "prompt.toast.imageModelUnsupported.title": "Model does not support images",
  "prompt.toast.imageModelUnsupported.description": "Choose a model with image input to attach images.",
  ...
  "dialog.server.description": "Switch which orgn server this app connects to.",
  ...
  "toast.update.description": "A new version of orgn ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the orgn team",
  "error.page.report.discord": "via support",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, orgn does not support MCP authentication yet.',
  ...
  "terminal.panel.debugConsole": "Debug Console",
  "terminal.panel.ports": "Ports",
  "terminal.panel.split": "Split terminal",
  "terminal.panel.kill": "Kill terminal",
  "terminal.panel.maximize": "Maximize terminal panel",
  "terminal.panel.restore": "Restore terminal panel",
  ...
  "sidebar.gettingStarted.line1": "orgn includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the orgn server inside WSL on Windows.",

  "settings.mcp.title": "MCP",
  "settings.mcp.description": "Configure global Model Context Protocol servers for every project.",
  "settings.mcp.servers.title": "Configured servers",
  "settings.mcp.servers.empty": "No MCP servers yet. Add one above, or paste config into the editor below.",
  "settings.mcp.servers.editingHint": "Save or reset to use toggles.",
  "settings.mcp.servers.add": "Add server",
  "settings.mcp.form.name.label": "Name",
  "settings.mcp.form.name.placeholder": "context7",
  "settings.mcp.form.type.label": "Type",
  "settings.mcp.form.type.remote": "Remote (URL)",
  "settings.mcp.form.type.local": "Local (command)",
  "settings.mcp.form.url.label": "Server URL",
  "settings.mcp.form.url.placeholder": "https://mcp.example.com/mcp",
  "settings.mcp.form.command.label": "Command",
  "settings.mcp.form.command.placeholder": "npx -y some-mcp-server",
  "settings.mcp.form.command.help": "Separate the command and its arguments with spaces.",
  "settings.mcp.form.headers.label": "Headers (optional)",
  "settings.mcp.form.headers.add": "Add header",
  "settings.mcp.form.env.label": "Environment variables (optional)",
  "settings.mcp.form.env.add": "Add variable",
  "settings.mcp.form.pair.key.label": "Key",
  "settings.mcp.form.pair.key.placeholder": "Name",
  "settings.mcp.form.pair.value.label": "Value",
  "settings.mcp.form.pair.value.placeholder": "Value",
  "settings.mcp.form.pair.remove": "Remove",
  "settings.mcp.form.submit": "Add server",
  "settings.mcp.form.submitting": "Adding...",
  "settings.mcp.form.error.name.required": "Give the server a name.",
  "settings.mcp.form.error.name.exists": 'A server named "{{name}}" already exists.',
  "settings.mcp.form.error.url.required": "Enter the server URL.",
  "settings.mcp.form.error.url.format": "The URL must start with http:// or https://.",
  "settings.mcp.form.error.command.required": "Enter the command to run.",
  "settings.mcp.editor.section": "Edit global config",
  "settings.mcp.configPath.title": "Global config directory",
  "settings.mcp.editor.label": "Global MCP JSON",
  "settings.mcp.editor.help":
    'Paste the contents of the global "mcp" object only. Project-local .opencode config is not shown here.',
  "settings.mcp.editor.placeholder":
    '{\n  "context7": {\n    "type": "remote",\n    "url": "https://mcp.context7.com/mcp"\n  }\n}',
  "settings.mcp.action.saving": "Saving...",
  "settings.mcp.action.format": "Format",
  "settings.mcp.action.openConfigFolder": "Open config folder",
  "settings.mcp.error.json": "This isn't valid JSON — check for a missing comma, quote, or bracket.",
  "settings.mcp.error.root": 'The MCP config must be a JSON object, like { "my-server": { ... } }.',
  "settings.mcp.error.entry.object": '"{{name}}" must be an object with a "type" field.',
  "settings.mcp.error.entry.type": '"{{name}}" needs a "type" of "remote" (for a URL) or "local" (for a command).',
  "settings.mcp.error.entry.url": '"{{name}}" is a remote server, so it needs a "url".',
  "settings.mcp.error.entry.command":
    '"{{name}}" is a local server, so it needs a "command" list, e.g. ["npx", "-y", "some-mcp"].',
  "settings.mcp.toast.saved.title": "MCP config saved",
  "settings.mcp.toast.saved.description": "MCP servers will reload for open projects.",
  "settings.mcp.toast.added.title": "Server added",
  "settings.mcp.toast.added.description": '"{{name}}" was added to your MCP servers.',
  ...
  "settings.general.row.language.description": "Change the display language for orgn",
  ...
  "settings.general.row.appearance.description": "Customise how orgn looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether orgn follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how orgn is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when orgn launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of orgn.",
