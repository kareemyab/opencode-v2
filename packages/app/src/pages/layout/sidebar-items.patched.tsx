...
export const SESSION_TREE_BASE = 8
export const SESSION_TREE_INDENT = 12
...
export const SessionTreeGroup = (props: { level?: number; class?: string; children: JSX.Element }): JSX.Element => (
  <div role="group" class={`flex flex-col gap-1 ${props.class ?? ""}`}>
    {props.children}
  </div>
)
...
export const SessionItem = (props: SessionItemProps): JSX.Element => {
  ...
  const inset = () => sessionTreeBranch(props.level ?? 0)
...
export const NewSessionItem = (props: {
  ...
  return (
    <div
      ...
      style={props.bleed ? { "padding-left": `${sessionTreeBranch(0)}px` } : undefined}
    >
      <div classList={{ "pr-3": props.bleed }}>
        <Show
          when={!tooltip()}
          fallback={
